...
```{r,out.width = "400px"}
knitr::include_graphics("/Users/malorh/Dropbox/GITHUB/Dashboarding-Tutorial/Slide_images/yaml_before.png")
``` 

### After :)
 
```{r,out.width = "400px"}
knitr::include_graphics("/Users/malorh/Dropbox/GITHUB/Dashboarding-Tutorial/Slide_images/yaml_after.png")
``` 
...
```{r,out.width = "500px"}
knitr::include_graphics("/Users/malorh/Dropbox/GITHUB/Dashboarding-Tutorial/Slide_images/yaml_goto.png")
```
...
> - modify template & css each each time you build a dashboard
> - start with the essential or the easiest wins
